    ...
    for (char symbol : input_string) {
        switch (current_state) {
            case 0:
                ...
                if (symbol == '2') current_state = 2;
                break;
            case 1:
                if (symbol == '0') current_state = 1;
                if (symbol == '1') current_state = 4;
                if (symbol == '2') current_state = 3;
                break;
            case 2:
                if (symbol == '0') current_state = 2;
                if (symbol == '1') current_state = 3;
                if (symbol == '2') current_state = 5;
                break;
            case 3:
                if (symbol == '0') current_state = 3;
                if (symbol == '1') current_state = 5;
                if (symbol == '2') current_state = 7;
                break;
            case 4:
                if (symbol == '0') current_state = 4;
                if (symbol == '1') current_state = 6;
                if (symbol == '2') current_state = 5;
                break;
            case 5:
                if (symbol == '0') current_state = 5;
                if (symbol == '1') current_state = 7;
                break;
            case 6:
