...
class Java9ParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by Java9Parser#emptyStatement_.
    def visitEmptyStatement_(self, ctx:Java9Parser.EmptyStatement_Context):
        return self.visitChildren(ctx)
